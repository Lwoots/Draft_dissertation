...
I then reconstructed ML trees on the merged partition datasets using IQtree v. For support values, I used 1000 ultrafast bootstraps (UFBoot, Hoang 2017), and Shimodaira-Hasegawa approximate likelihood-ratio test (SH-aLRT) (Shimodaira 1999, Guindon 2010) -alrt 1000. The SH-aLRT evaluates whether the addition of a given branch improves the likelihood of the tree relative to removing that branch but leaving the rest of the tree topology identical. With these support metrics, a node is considered to have good support if it has greater than 95% UFBoot value, and greater than 80% Sh-aLRT value.



SH-aLRT measures the significance of the difference between the likelihoods of the best and the second best topological arrangements around a given branch (Anisimova 2006, Guindon 2010)
