...
The histories of genes often differ from the history of a species due to incomplete lineage sorting, horizontal transfer etc resulting in gene trees that differ from the true species tree. The multi-species coalescent model describes  Astral is a summary based method that is consistent with msc. Astral uses quartets
