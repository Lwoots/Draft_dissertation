...
Non-adaptive radiation occurs when lineages diversify with little niche differentiation [ @Czen.], often due to the restriction of gene flow by a geographic barrier, resulting in allopatric or parapatric taxa  [@Gittenberger1991; @Rundell2009]. Speciation in non-adaptive radiations is driven by neutral processes such as genetic drift, whereby populations with limited to nonexistent external gene flow diverge via the random fixation of alleles.
